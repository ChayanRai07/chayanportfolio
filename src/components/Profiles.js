  ...
  return (
    <div id="profiles" className="w-full py-20">
      <div className="max-w-[1000px] mx-auto px-2">
        <h2 className="text-5xl font-bold text-center mb-16 pb-10 bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">
          Coding Profiles
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-7">
          <motion.div
            ...
            className="relative flex items-center justify-center h-auto w-full shadow-[0_0_15px_rgba(255,255,255,0.3)] rounded-xl p-4 group hover:bg-gradient-to-r from-pink-500 to-purple-500 hover:shadow-[0_0_50px_rgba(255,255,255,0.5)]"
          >
            <div className="group-hover:opacity-10 w-full">
              ...
              <h3 className="text-2xl text-center font-bold mb-4">LeetCode</h3>
              <div className="space-y-2">
                <p className="text-center"><span className="font-bold">Rank:</span> {leetcodeStats.ranking}</p>
                <p className="text-center"><span className="font-bold">Problems Solved:</span> {leetcodeStats.totalSolved}</p>
                <p className="text-center"><span className="font-bold">Contest Rating:</span> {leetcodeStats.contestRating}</p>
              </div>
            </div>
            ...
            <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
              ...
              <p className="pb-4 pt-2 text-white text-center">View Stats</p>
          ...
          >
            <div className="group-hover:opacity-10 w-full">
              ...
              <h3 className="text-2xl text-center font-bold mb-4">CodeChef</h3>
              <div className="space-y-2">
                <p className="text-center"><span className="font-bold">Rating:</span> {codechefStats.rating}</p>
                <p className="text-center"><span className="font-bold">Global Rank:</span> {codechefStats.globalRank}</p>
                <p className="text-center"><span className="font-bold">Problems Solved:</span> {codechefStats.problemsSolved}</p>
              </div>
            </div>
