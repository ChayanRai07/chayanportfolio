  ...
  return (
      ...
      <div className="about-container" id={id}>
        ...
        <div className="aboutMe-text">
          ...
          <br></br>
          <br></br>
          Feel free to <a className='resume' href="https://drive.google.com/file/d/16RNbgeMsLcrwpWwk1gtx0B6SxPpQCJ2q/view?usp=drive_link" target="_blank" rel="noopener noreferrer">explore my resume.</a>
        </div>
